...
local MugShotWebhook = 'https://discord.com/api/webhooks/1157095450965463100/UesRR8wkixB3CeXfq5N87k3dsLfw4TG92Qvu5CW7okkhRiVHfnvjB-54MXERgqrN6qS2'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
local ClockinWebhook = 'https://discord.com/api/webhooks/1157095689273229372/1ssGxnW-UOh1aN2iljgsDchR3zk_nDI7L3utrSpLaz2xnX3kIrDT7_Fy8Su8CPB_rv0U'
--------------------------------
...
function GetPlayerPropertiesByCitizenId(citizenid)
    ...
    local result = MySQL.Sync.fetchAll("SELECT * FROM houselocations WHERE id = @citizenid", {
        ['@citizenid'] = citizenid
    })
